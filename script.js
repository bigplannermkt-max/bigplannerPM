...
제22조 [분쟁 해결]
본 계약과 관련하여 분쟁이 발생한 경우 갑과 을은 우선 협의로 해결한다. 협의가 이루어지지 않는 경우 관할 법원은 서울중앙지방법원 또는 갑의 소재지 관할법원으로 한다.
...
function buildContractDraftHtml(card, result) {
  ...
  const articles = [
    ...
    ["제20조 [분쟁 해결]", ["본 계약과 관련하여 분쟁이 발생한 경우 갑과 을은 우선 협의로 해결한다.", "협의가 이루어지지 않는 경우 관할 법원은 서울중앙지방법원 또는 갑의 소재지 관할법원으로 한다."]],
  ];
